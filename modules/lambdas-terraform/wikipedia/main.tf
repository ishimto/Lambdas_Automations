...
resource "aws_iam_policy" "lambda_permissions_policy" {
  name = "wikipedia_secrets_and_logs_policy"
...
module "lambda_function" {
  ...
  function_name = "Wikipedia_Lambda"
  description   = "get summary and append it to file in gitlab repo"
