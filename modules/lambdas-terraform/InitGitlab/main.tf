...
resource "aws_iam_policy" "lambda_permissions_policy" {
  name = "init_gitlab_secrets_and_logs_policy"
...
module "lambda_function" {
  ...
  function_name = "Init_Gitlab_Lambda"
  description   = "Init Gitlab users with initial data imported from google sheets"
